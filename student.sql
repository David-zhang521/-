...
INSERT INTO `cls` VALUES (1,'Lily',13,'w',91.5),(2,'Tom',12,'m',76),(3,'Lucy',12,'w',93),(4,'Tony',14,'o',80),(5,'Emma',13,'w',0),(6,'Joy',14,'m',77),(7,'David',NULL,'m',86);
...
CREATE TABLE `course` (
  ...
  PRIMARY KEY (`id`),
  KEY `t_ft` (`tid`),
  CONSTRAINT `t_ft` FOREIGN KEY (`tid`) REFERENCES `teacher` (`id`)
...
INSERT INTO `interest` VALUES (1,'Emma','sing,dance',16800.00,'18049465807','骨骼惊奇,练舞奇才'),(2,'Lily','dance',8000.00,NULL,'骨骼惊奇');
...
INSERT INTO `marathon` VALUES (1,'曹操','1990-02-05','2020-01-05 12:12:12','02:10:13'),(2,'关羽','1991-07-05','2020-01-07 12:12:59','02:15:13'),(3,'孙权','1991-07-05','2020-02-01 17:12:39','02:35:53');
...
/*!50001 VIEW `good_stu` AS select `cls`.`name` AS `name`,`cls`.`age` AS `age`,`cls`.`sex` AS `sex`,`interest`.`hobby` AS `hobby` from (`cls` left join `interest` on((`cls`.`name` = `interest`.`name`))) */;
...
-- Dump completed on 2020-02-26 11:36:48
